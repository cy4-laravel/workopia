    ...
    <div
            ...
            >
                ...
                @method('PUT')
                    ...
                    <x-inputs.text type="email" id="contact_email" name="contact_email" label="Contact Email" placeholder="Enter Contact Email" :value="old('contact_email', $job->contact_email)" />
